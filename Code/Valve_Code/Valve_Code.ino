...
void loop() {
  ...
  int Valve6S = analogRead(Valve6);
      ...
      if (Valve2S <= 500)
      {   digitalWrite (ValveSound2,LOW);
          delay(300);
          digitalWrite (ValveSound2,HIGH);   }
      else digitalWrite (ValveSound2, HIGH);

      if (Valve3S <= 500)
      {   digitalWrite (ValveSound3,LOW);
          delay(300);
          digitalWrite (ValveSound3,HIGH);   }
             else digitalWrite (ValveSound3, HIGH);

      if (Valve4S <= 500)
      {   digitalWrite (ValveSound4,LOW);
          delay(300);
          digitalWrite (ValveSound4,HIGH);   }
             else digitalWrite (ValveSound4, HIGH);

      if (Valve5S <= 500)
      {   digitalWrite (ValveSound5,LOW);
          delay(300);
          digitalWrite (ValveSound5,HIGH);   }
             else digitalWrite (ValveSound5, HIGH);

      if (Valve6S <= 500)
      {   digitalWrite (ValveSound6,LOW);
          delay(300);
          digitalWrite (ValveSound1,HIGH);   }
             else digitalWrite (ValveSound6, HIGH);

if (Valve1S <= 500 && Valve2S >= 500 && Valve3S <= 500 && Valve4S >= 500 && Valve5S >= 500 && Valve6S <= 500)
