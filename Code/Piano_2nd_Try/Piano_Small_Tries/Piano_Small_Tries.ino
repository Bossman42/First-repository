...
//Reset Key  
      if (Key6S == LOW){
      digitalWrite(Led1, HIGH);digitalWrite(Led2, HIGH);digitalWrite(Led3, HIGH);digitalWrite(Led4, HIGH);digitalWrite(Led5, HIGH);digitalWrite(Led6, HIGH);digitalWrite(Led7, HIGH);digitalWrite(Led8, HIGH);digitalWrite(Led9, HIGH);digitalWrite(Led10, HIGH);digitalWrite(Led11, HIGH);digitalWrite(Led12, HIGH);digitalWrite(Led13, HIGH);digitalWrite(Led14, HIGH);digitalWrite(Led15, HIGH);digitalWrite(Led16, HIGH);  }                             // Reset Key
